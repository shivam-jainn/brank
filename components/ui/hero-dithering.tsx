...
export function HeroDitheringCTA({
  ...
  return (
    ...
    >
      <Button className={cn("font-pixel-square", buttonClassName)} size="lg" render={<a href={href} onClick={onClick} rel={rel} target={target} />} nativeButton={false}>{label}</Button>
    </div>
  )
}
